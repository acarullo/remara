...
public class NewCase extends BasePage implements FindPopupIllness, FindPopupPatient {
    ...
    public NewCase(final PageParameters parameters) {
        super();
        ...
        final Button save = new Button("save", new Model(getString("save"))) {
    ...
    private void createForm(final PageParameters parameters) {
        ...
        if (newCase) {
            ...
            medicineCase.setExams(new ArrayList<Exam>());
            medicineCase.getExams().addAll(caseManagement.getExamsOfMC(medicineCase.getId()));
        ...
        form = new Form("caseForm", new CompoundPropertyModel(medicineCase)) {
            ...
            protected void onSubmit() {
                if ("save".equals(typeButton)) {
                    ...
                    PageParameters savedParameters = new PageParameters();
                    savedParameters.put("medicineCase", medicineCase);
                    setResponsePage(new SavedCase(savedParameters));
                }
    ...
    private void createPopupPatient() {
        ...
        patientPopup.setPageCreator(new ModalWindow.PageCreator() {
            ...
            public Page createPage() {
                ...
                return new PatientPopup(new PageParameters(), NewCase.this, patientPopup);
            }
        });
        ...
        illnessPopup.setPageCreator(new ModalWindow.PageCreator() {
            ...
            public Page createPage() {
                ...
                return new IllnessPopup(
                        new PageParameters(), NewCase.this, illnessPopup);
            }
        });
    ...
    private void createIllness() {
        final Model<String> exactlyIllnessModel = new Model() {
            ...
            public Serializable getObject() {
                ...
                if (StringUtils.isBlank(exactlyIllness) || "null".equals(exactlyIllness)) {
                    return getString("noExactlyIllness");
                }
            ...
            public void setObject(final Serializable object) {
                if (object != null) {
                    ...
                    if (object instanceof Date) {
                        ...
                        LOG.info("Setting diagnosis date illness to {}", data);

                        medicineCase.setDiagnosisDateIllness(data);
                    } else {
                        try {
                            LOG.info("Setting diagnosis date illness to {}", object.toString());
...
//                diagnosisDateIllnessModel, getString("format_date"));
        ...
        final TextField diagnosisDateIllness = new TextField<Date>("diagnosisDateIllness", diagnosisDateIllnessModel);

        diagnosisDateIllness.add(new SimpleAttributeModifier("title", getString("diagnosisDateIllness")));

        final DatePicker diagnosisIllnessDatePicker = new DatePicker() {
        ...
        diagnosisDateIllness.add(diagnosisIllnessDatePicker);

        diagnosisDateIllness.add(new CustomDateValidator());
            ...
            public void setObject(final Serializable object) {
                if (object != null) {
                    ...
                    if (object instanceof Date) {
                        ...
                        LOG.info("Setting Starting date illness to {}", data);

                        medicineCase.setStartingDateIllness(data);
                    } else {
                        try {
                            LOG.info("Setting starting date illness to {}", object.toString());
...
//                startingDateIllnessModel, getString("format_date"));
        ...
        final TextField startingDateIllness = new TextField<Date>("startingDateIllness", startingDateIllnessModel);

        startingDateIllness.add(new SimpleAttributeModifier("title", getString("startingDateIllness")));

        final DatePicker startingIllnessDatePicker = new DatePicker() {
        ...
        startingDateIllness.add(startingIllnessDatePicker);

        startingDateIllness.add(new CustomDateValidator());
    ...
    private void createFindHospital() {
        ...
        hoPopup.setPageCreator(new ModalWindow.PageCreator() {
            ...
            public Page createPage() {
                ...
                return new HoPopup(pageParameters, hoPopup, NewCase.this);
            }
        });
    ...
    private void createPopupWard() {
        ...
        wardPopup.setPageCreator(new ModalWindow.PageCreator() {
            ...
            public Page createPage() {
                ...
                return new WardPopup(pageParameters, wardPopup, NewCase.this);
            }
        });
                    ...
                    public void onClick(AjaxRequestTarget target) {
                        ...
                        examPopup.setPageCreator(new ModalWindow.PageCreator() {
                            ...
                            public Page createPage() {
                                ...
                                editedExam = exam;
                                medicineCase.getExams().remove(exam);
                                return new ExamPopup(parameters, NewCase.this, examPopup);
                            }
                        });
