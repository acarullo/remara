 ...
 *  under the License.
 */
package net.tirasa.remara.persistence.jpasymphony.module.propertyset.jpa;
...
import net.tirasa.remara.persistence.jpasymphony.workflow.spi.jpa.JPAPropertySetDelegate;
...
public class JPAPropertySet extends AbstractPropertySet {
     ...
     * Logger.
     */
    private static final Logger LOG = LoggerFactory.getLogger(JPAPropertySet.class);
